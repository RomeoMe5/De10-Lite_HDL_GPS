...
4. В данном состоянии можно обрабатывать значение север/юг широты. Используемая плата имеет всего 6 семисегментных индикаторов, на 3 из которых выводилась координата широты, а на 3 других – координата долготы – поэтому значения север/юг широты и восток/запад долготы не обрабатывались, т.к. их некуда выводить, однако добавить их обработку не составит труда, т.к. состояние для этих случаев уже написано и нужно просто записать полученные данные в желаемую переменную.
